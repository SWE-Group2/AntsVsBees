...
/** Tests for HungryAnt class. Checks food cost, armor, digestion, and bee eating behaviour. */
class HungryAntTest {
  ...
  /** Test that HungryAnt starts with 0 digestion turns meaning it is ready to eat straight away */
  @Test
