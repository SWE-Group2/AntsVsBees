...
/**
 * Tests for ZombieBee class.
 * Checks that ZombieBee can attack multiple ants at once.
 */
class ZombieBeeTest
{
    /**
    ...
    void zombieBeeAttacksMultipleAnts()
    {
        ...
        // place WallAnts in 3 consecutive places
        WallAnt wall1 = new WallAnt();
        WallAnt wall2 = new WallAnt();
        WallAnt wall3 = new WallAnt();
        places[0].addInsect(wall1);
        places[1].addInsect(wall2);
        places[2].addInsect(wall3);

        // place zombie bee in first place
        ZombieBee zombie = new ZombieBee(3);
        places[0].addInsect(zombie);
