...
/**
 * An Ant that throws leaves at bees.
...
public class ThrowerAnt extends Ant
{
    ...
    /**
     * Creates a new ThrowerAnt.
     * Post-condition: food cost is 4, armor is 1, damage is 1
     */
    public ThrowerAnt()
    {
        super(1); // armor = 1
    ...
    /**
     * Returns the nearest bee within range to throw at.
     * Post-condition: returns a Bee or null if no bee in range
     */
