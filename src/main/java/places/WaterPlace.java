...
/**
 * Only an insect that is watersafe can be deployed to a Water place.
 * Bees can fly and so they are watersafe (set to true)
 * 
...
public class WaterPlace extends Place {
    ...
    /*
     * override the addInsect method to only allow watersafe insects to be added to
     * this place. If a non-watersafe insect is added, it should be removed from the
     * game (i.e., not added to the place and not have a location).
     */
    @Override
