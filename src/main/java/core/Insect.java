...
public abstract class Insect {
	...
	/**
	 * Has the insect move out of its current location. Abstract in case the insect
	 * takes action when it leaves
	 */
	 ...
	 * 
	 * @param colony The colony in which this action takes place (to support
	 *               wide-spread effects)
	 */
