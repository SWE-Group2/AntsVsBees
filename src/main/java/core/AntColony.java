...
public class AntColony {
	 ...
	 * @param moatFrequency The frequency of which moats (water areas) appear. 0
	 *                      means that there are no moats
	...
	/**
	 * Returns an array of Places in this colony. Places are ordered by tunnel, with
	 * each tunnel's places listed start to end.
	 * 
	...
	/**
	 * Returns if there are any bees in the queen's location (and so the game should
	 * be lost)
	 * 
	...
	/**
	 * Places the given ant in the given tunnel IF there is enough available food.
