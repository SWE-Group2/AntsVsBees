...
public class Place {
    ...
    /**
     * Checks whether an insect can be added to this place. Normal places accept all insects. WaterPlace overrides this
     * to only allow watersafe insects.
     *
     * @param insect
     *            The insect to check
    ...
    /**
     * Adds an ant to the place. Special case: if a BodyguardAnt is being added and there is already an ant here, the
     * BodyguardAnt wraps around the existing ant and protects it. Also if there is already a BodyguardAnt here, a new
     * ant can go inside it.
     *
     * @param ant
    ...
    /**
     * Removes the ant from the place. If the ant being removed is a BodyguardAnt, the ant it was protecting takes its
     * place.
     *
     * @param ant
