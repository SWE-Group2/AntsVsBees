...
/**
 * A FireAnt does nothing on its turn.
 * BUT when it dies, it damages ALL bees in the same place by its damage value.
...
public class FireAnt extends Ant
{
     ...
     * Post-condition: food cost is 4, armor is 1, damage is 3
     */
    public FireAnt()
    {
        super(1); // armor = 1
    ...
    /**
     * FireAnt does nothing on its turn.
     * Its power only activates when it dies.
    ...
    /**
     * Overrides reduceArmor to trigger the fire explosion when armor hits 0.
     * When FireAnt dies, it damages ALL bees in its place by its damage value.
     * 
     * Pre-condition: amount must be greater than 0
     * Post-condition: if armor reaches 0, all bees in same place take damage
     * 
