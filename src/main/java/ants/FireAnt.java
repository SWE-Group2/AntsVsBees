...
/**
 * A FireAnt does nothing on its turn. BUT when it dies, it damages ALL bees in the same place by its damage value.
 * Think of it like a bomb - it explodes when it dies!
 *
 * <p>
 * Food Cost: 4, Armor: 1, Damage: 3
 *
...
public class FireAnt extends Ant {
    ...
    /**
     * FireAnt does nothing on its turn. Its power only activates when it dies. Pre-condition: colony must not be null
    ...
    /**
     * Overrides reduceArmor to trigger the fire explosion when armor hits 0. When FireAnt dies, it damages ALL bees in
     * its place by its damage value.
     *
     * <p>
     * Pre-condition: amount must be greater than 0 Post-condition: if armor reaches 0, all bees in same place take
     * damage
     *
     * @param amount
