...
/**
 * A HungryAnt is an ant that eats bees!
 * It randomly picks a bee from its location and instantly kills it.
 * However, after eating a bee, it needs 3 turns to digest before it can eat again.
 * 
 * Food Cost: 4, Armor: 1
 * 
...
public class HungryAnt extends Ant
{
     ...
     * Starts with 0 digestion turns (ready to eat straight away).
    ...
    /**
     * Each turn, the HungryAnt either:
     * - Eats a random bee if it is not digesting
     * - Counts down its digestion timer if it is still digesting
     * 
     * Pre-condition: colony must not be null
     * Post-condition: either a bee is eaten or digestion timer decreases by 1
     * 
