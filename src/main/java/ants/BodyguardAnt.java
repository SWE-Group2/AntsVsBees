...
/**
 * A BodyguardAnt is a special ant that can share a place with another ant. It shields the other ant
 * from damage - bees must kill the BodyguardAnt first before they can hurt the ant it is
 * protecting.
 *
 * <p>Food Cost: 4, Armor: 2
 *
...
public class BodyguardAnt extends Ant {
  ...
  /**
   * BodyguardAnt does nothing on its turn. It just stands there and takes hits for the ant it
   * protects. Pre-condition: colony must not be null Post-condition: no change to colony or game
   * state
   */
  @Override
  ...
  /**
   * Removes the BodyguardAnt from its place. If it was protecting another ant, that ant stays in
   * the place.
   */
  @Override
